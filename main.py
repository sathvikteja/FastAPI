...
class Patient(BaseModel):
    ...
    height: Annotated[float,Field(...,gt=0,decription='height of the patient in mtrs')]
    weight: Annotated[float,Field(...,gt=0,dsecription='weight of the patient in kgs')]
...
def update_patient(patient_id: str, patient_update: PatientUpdate):
    ...
    # existing_patient_info -> pydantic model -> updated bmi -> verdict
